...
from backend.api.v1.labelstudio.router import (
    router as labelstudio_router,
)
from backend.api.v1.inference.router import (
    router as inference_router,
)
from backend.api.v1.minio.router import router as minio_router
from backend.api.v1.postgres.router import (
    router as postgres_router,
)
from backend.api.v1.training.router import (
